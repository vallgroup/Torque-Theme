...
require( Torque_Image_Grid_PATH . 'shortcode/torque-image-grid-tinymce-class.php' );

class Torque_Image_Grid_Shortcode {

  public static $SHORTCODE_SLUG = 'torque_image_grid';
  ...
  public function __construct() {
    ...
    add_action( 'load-post.php'    ,  array(
      Torque_Image_Grid_TinyMCE::get_inst(),
      'init' ),
    20 );
  ...
  private function get_markup() {
    ...
    return '<span
      class="torque-image-grid-react-entry"
