 ...
 */
class Torque_Image_Grid_TinyMCE {
	 ...
	 * @var string
	 */
	public static $TINYMCE_PLUGIN_BUTTON_FILTER = 'torque_image_grid_tinymce_plugin_button';
	...
	public function mce_plugin( $plugin_array ) {
		$plugin_array['torque_image_grid'] = '/wp-content/plugins/torque-image-grid/shortcode/torque-image-grid-tinymce-plugin.js';
		return $plugin_array;
	}

	public function mce_button( $buttons ) {
    array_push( $buttons, 'torque_image_grid_button' );
		return $buttons;
	}

	public function insert_editor( $hook ) {
		?>
		<div id="torque-image-grid-builder" style="display:none;">
		</div>
		<?php
	}
	...
	public function media_templates() {
      ...
      return;
		include_once 'torque-image-grid-tinymce-editor.html';
	}
}
