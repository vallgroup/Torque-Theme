 ...
 */
class Torque_Filtered_Gallery_TinyMCE {
	 ...
	 * @var string
	 */
	public static $TINYMCE_PLUGIN_BUTTON_FILTER = 'torque_filtered_gallery_tinymce_plugin_button';
	...
	public function mce_plugin( $plugin_array ) {
		$plugin_array['torque_filtered_loop'] = '/wp-content/plugins/torque-filtered-gallery/shortcode/torque-filtered-gallery-tinymce-plugin.js';
		return $plugin_array;
	}

	public function mce_button( $buttons ) {
    array_push( $buttons, 'torque_filtered_gallery_button' );
		return $buttons;
	}

	public function insert_editor( $hook ) {
		?>
		<div id="torque-filtered-gallery-builder" style="display:none;">
		</div>
		<?php
	}
	...
	public function media_templates() {
      ...
      return;
		include_once 'torque-filtered-gallery-tinymce-editor.html';
	}
}
