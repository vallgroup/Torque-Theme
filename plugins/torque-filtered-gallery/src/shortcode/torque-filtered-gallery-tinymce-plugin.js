(function($) {
  $(document).ready(function() {
    ...
    wp.mce.torque_filtered_loop = {
      ...
      // set our template
      // @see editor-torque-filtered-gallery-template.html
      template: wp.media.template("editor-torque-filtered-gallery-template"),
  ...
  tinymce.PluginManager.add("torque_filtered_loop", function(editor) {
    editor.addButton("torque_filtered_gallery_button", {
      text: "Torque Filtered Gallery",
      icon: false,
      onclick: function() {
