 ...
 */
class Torque_RecruiterBox_TinyMCE {
	 ...
	 * @var string
	 */
	public static $TINYMCE_PLUGIN_BUTTON_FILTER = 'torque_recruiterbox_tinymce_plugin_button';
	...
	public function mce_plugin( $plugin_array ) {
		$plugin_array['torque_recruiterbox'] = '/wp-content/plugins/torque-recruiterbox/shortcode/torque-recruiterbox-tinymce-plugin.js';
		return $plugin_array;
	}

	public function mce_button( $buttons ) {
    array_push( $buttons, 'torque_recruiterbox_button' );
		return $buttons;
	}

	public function insert_editor( $hook ) {
		?>
		<div id="torque-recruiterbox-builder" style="display:none;">
		</div>
		<?php
	}
	...
	public function media_templates() {
      ...
      return;
		include_once 'torque-recruiterbox-tinymce-editor.html';
	}
}
