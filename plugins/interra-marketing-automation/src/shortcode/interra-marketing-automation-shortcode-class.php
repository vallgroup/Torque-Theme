...
require( Interra_Marketing_Automation_PATH . 'shortcode/interra-marketing-automation-tinymce-class.php' );

class Interra_Marketing_Automation_Shortcode {

  public static $SHORTCODE_SLUG = 'Interra_Marketing_Automation';
  ...
  public function __construct() {
    ...
    add_action( 'load-post.php'    ,  array(
      Interra_Marketing_Automation_TinyMCE::get_inst(),
      'init' ),
    20 );
  ...
  private function get_markup() {
    ...
    return '<span
      class="interra-marketing-automation-react-entry"
