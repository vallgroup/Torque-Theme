...
<head>
  ...
  <title><?php echo $document->post_title; ?></title>
...
<style type="text/css">
	...
	*/
		#templateFooter{
			/*@editable*/background-color:#696a6d;
			/*@editable*/background-image:none;
			/*@editable*/background-repeat:no-repeat;
			/*@editable*/background-position:center;
			/*@editable*/background-size:cover;
	...
	*/
    ...
    <body>
        <!--*|IF:MC_PREVIEW_TEXT|*-->
        <!--[if !gte mso 9]><!----><span class="mcnPreviewText" style="display:none; font-size:0px; line-height:0px; max-height:0px; max-width:0px; opacity:0; overflow:hidden; visibility:hidden; mso-hide:all;">Interra Realty Offer Memorandum - <?php echo $document->post_title; ?></span><!--<![endif]-->
        <!--*|END:IF|*-->
        <center>
