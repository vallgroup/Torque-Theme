...
require_once( Torque_Rentcafe_Tour_API_ROOT . 'controllers/torque-rentcafe-tour-controller-class.php');

class Torque_Rentcafe_Tour_Routes {
  ...
  public function register_routes() {
    ...
    register_rest_route( $this->namespace, self::$resource , array(
	  	array(
	  		...
	  		'args'                => Torque_Rentcafe_Tour_Controller::get_examples_args(),
    ...
    register_rest_route( $this->namespace, self::$resource, array(
	  	array(
	  		...
	  		'args'                => Torque_Rentcafe_Tour_Controller::update_example_args(),
	  ...
	  register_rest_route( $this->namespace, self::$resource, array(
	  	array(
	  		...
	  		'args'                => Torque_Rentcafe_Tour_Controller::delete_example_args(),
	  		'permission_callback' => array('Torque_API_Permissions', 'user_can_create'),
	  	),
	  ) );
  }
  ...
  public function get_example( $request ) {
    $controller = new Torque_Rentcafe_Tour_Controller( $request );
