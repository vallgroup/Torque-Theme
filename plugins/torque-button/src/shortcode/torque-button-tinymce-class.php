...
class Torque_Button_TinyMCE {
	 ...
	 * @var string
	 */
	public static $TINYMCE_PLUGIN_BUTTON_FILTER = 'torque_button_tinymce_plugin_button';
	...
	public function mce_plugin( $plugin_array ) {
		$plugin_array['torque_button'] = '/wp-content/plugins/torque-button/shortcode/torque-button-tinymce-plugin.js';
		return $plugin_array;
	}

	public function mce_button( $buttons ) {
    array_push( $buttons, 'torque_button_button' );
		return $buttons;
	}

	public function insert_editor( $hook ) {
		?>
		<div id="torque-button-builder" style="display:none;">
		</div>
		<?php
	}
	...
	public function media_templates() {
      ...
      return;
		include_once 'torque-button-tinymce-editor.html';
	}
}
