...
class Torque_Rentcafe_TinyMCE {
	 ...
	 * @var string
	 */
	public static $TINYMCE_PLUGIN_BUTTON_FILTER = 'torque_rentcafe_tinymce_plugin_button';
	...
	public function mce_plugin( $plugin_array ) {
		$plugin_array['torque_rentcafe'] = '/wp-content/plugins/torque-rentcafe/shortcode/torque-rentcafe-tinymce-plugin.js';
		return $plugin_array;
	}

	public function mce_button( $buttons ) {
    array_push( $buttons, 'torque_rentcafe_button' );
		return $buttons;
	}

	public function insert_editor( $hook ) {
		?>
		<div id="torque-rentcafe-builder" style="display:none;">
		</div>
		<?php
	}
	...
	public function media_templates() {
      ...
      return;
		include_once 'torque-rentcafe-tinymce-editor.html';
	}
}
