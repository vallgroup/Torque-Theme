...
require( Torque_Rentcafe_PATH . 'shortcode/torque-rentcafe-tinymce-class.php' );

class Torque_Rentcafe_Shortcode {

  public static $SHORTCODE_SLUG = 'torque_rentcafe';
  ...
  public function __construct() {
    ...
    add_action( 'load-post.php'    ,  array(
      Torque_Rentcafe_TinyMCE::get_inst(),
      'init' ),
    20 );
  ...
  private function get_markup() {
    ...
    return '<span
      class="torque-rentcafe-react-entry"
