...
require( Torque_Slideshow_PATH . 'shortcode/torque-slideshow-tinymce-class.php' );

class Torque_Slideshow_Shortcode {

  public static $SHORTCODE_SLUG = 'torque_slideshow';
  ...
  public function __construct() {
    ...
    add_action( 'load-post.php'    ,  array(
      Torque_Slideshow_TinyMCE::get_inst(),
      'init' ),
    20 );
  ...
  private function get_markup() {
    ...
    return '<span
      class="torque-slideshow-react-entry"
