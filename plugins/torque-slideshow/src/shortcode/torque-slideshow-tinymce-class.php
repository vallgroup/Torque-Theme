 ...
 */
class Torque_Slideshow_TinyMCE {
	 ...
	 * @var string
	 */
	public static $TINYMCE_PLUGIN_BUTTON_FILTER = 'torque_slideshow_tinymce_plugin_button';
	...
	public function mce_plugin( $plugin_array ) {
		$plugin_array['torque_slideshow'] = '/wp-content/plugins/torque-slideshow/shortcode/torque-slideshow-tinymce-plugin.js';
		return $plugin_array;
	}

	public function mce_button( $buttons ) {
    array_push( $buttons, 'torque_slideshow_button' );
		return $buttons;
	}

	public function insert_editor( $hook ) {
		?>
		<div id="torque-slideshow-builder" style="display:none;">
		</div>
		<?php
	}
	...
	public function media_templates() {
      ...
      return;
		include_once 'torque-slideshow-tinymce-editor.html';
	}
}
