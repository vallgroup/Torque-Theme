 ...
 */
class Torque_US_States_TinyMCE {
	 ...
	 * @var string
	 */
	public static $TINYMCE_PLUGIN_BUTTON_FILTER = 'torque_us_states_tinymce_plugin_button';
	...
	public function mce_plugin( $plugin_array ) {
		$plugin_array['torque_us_states'] = '/wp-content/plugins/torque-us-states/shortcode/torque-us-states-tinymce-plugin.js';
		return $plugin_array;
	}

	public function mce_button( $buttons ) {
    array_push( $buttons, 'torque_us_states_button' );
		return $buttons;
	}

	public function insert_editor( $hook ) {
		?>
		<div id="torque-us-states-builder" style="display:none;">
		</div>
		<?php
	}
	...
	public function media_templates() {
      ...
      return;
		include_once 'torque-us-states-tinymce-editor.html';
	}
}
